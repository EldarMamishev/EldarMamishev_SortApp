...
{
    [TestClass]
    public class SelectionSortTest : SortStrategyBaseTest
    {
        protected override SortStrategyBase GetSortStrategy(ISortType sortType, IStepCounter stepCounter) => new SelectionSort(sortType, stepCounter);
    }
}
