...
{
    [TestClass]
    public class InsertionSortTest : SortStrategyBaseTest
    {
        protected override SortStrategyBase GetSortStrategy(ISortType sortType, IStepCounter stepCounter) => new InsertionSort(sortType, stepCounter);
    }
}
